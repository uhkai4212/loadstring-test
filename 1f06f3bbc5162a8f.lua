local WindUI = loadstring(game:HttpGet("https://github.com/Footagesus/WindUI/releases/latest/download/main.lua"))();
	...
	WindUI:Popup({
		...
		Icon = "info",
		Content = gradient("This script made by", Color3.fromHex("#10eb3c"), Color3.fromHex("#67c97a"))   .. gradient(" TravHub", Color3.fromHex("#001e80"), Color3.fromHex("#16f2d9")) ,
		Buttons = {
			{
	...
	local Window = WindUI:CreateWindow({
		Title = gradient("TravHub [SUMMER UPDATE]", Color3.fromHex("#001e80"), Color3.fromHex("#ffea00")),
		Icon = "infinity",
...
local function ballfarm()
	...
	Tabs.SocialsTab:Paragraph({
		Title = gradient("xYSF", Color3.fromHex("#001e80"), Color3.fromHex("#16f2d9")),
		Desc = "My socials",
		Image = "bird",
		Color = "Green",
		Buttons = {
			{
				...
				Title = "YT - @xYSF",
				Callback = function()
					if pcall(setclipboard, "https://www.youtube.com/@xysf") then
						WindUI:Notify({
							Title = "Copied!",
	...
	Tabs.SocialsTab:Paragraph({
		Title = gradient("PayPal", Color3.fromHex("#ffffff"), Color3.fromHex("#363636")),
		Desc = "@openda19",
		Image = "bird",
		Color = "Green",
		Buttons = {
			{
				Title = "PayPal - @openda19",
				Icon = "circle",
				Callback = function()
					if pcall(setclipboard, "https://www.paypal.me/@openda19") then
						WindUI:Notify({
							Title = "Copied!",
