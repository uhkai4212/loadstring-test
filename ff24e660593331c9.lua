...
TextLabel.Text = "Made by melidon"
...
game:GetService("StarterGui"):SetCore("SendNotification", { 
    Title = "Don't say its yours";
    Text = "Fly gui by melidos";
...
local speed = 50 -- speed that you wanted