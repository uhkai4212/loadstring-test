...
local Window = Rayfield:CreateWindow({
   Name = "LAZER HUB | Paid Script | South Bronx: The Trenches❗",
   LoadingTitle = LAZER!! Paid Script",
   LoadingSubtitle = "Created by jaylenjay27319",
   ConfigurationSaving = {
      Enabled = true,
    ...
    Discord = {
        Enabled = true,
        Invite = "https://discord.gg/FjSTDphp",
        RememberJoins = true
    },
   KeySystem = true, -- lock the KeySystem as true
    KeySettings = {
        Title = "LAZER Key System",
        Subtitle = "Created by LAZER",
        Note = "To get the key, add jaylenjay27319 on discord",
        FileName = "LAZER HUB KEY",
        SaveKey = true, -- Key won't be saved permanently
        GrabKeyFromSite = false,
        Key = {"LAZERONTOP"} -- List of accepted keys or key URLs
    }
})

Rayfield:Notify({
   Title = "Welcome To LAZER HUB",
   ...
   Actions = { -- Notification Buttons
      Ignore = {
         Name = "...",
         Callback = function()
         print("Join Discord https://discord.gg/72g3v3Us")
         print("Join Discord https://discord.gg/72g3v3Us")
         print("Join Discord https://discord.gg/72g3v3Us")
         print("Join Discord https://discord.gg/72g3v3Us")
         print("Join Discord https://discord.gg/72g3v3Us")
